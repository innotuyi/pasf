  ...
  <div class="container-fluid content" id="contentContainer-fluid">
    ...
    <div class="row prod" >
      ...
      <div class="col-md-9" id="content">
        ...
        <h4 class="text-center head-content">Products Categories</h4>
        ...
        <?php 
          ...
          foreach ($data as $dataSet) {   ?>
            ...
            <div class="col-md-3 category-div"  style="background-image: url('../img/<?php echo htmlentities($dataSet->tbl_product_categPhoto);  ?>');">
