        ...
        <div class="col-md-10">
          ...
          <div class="col-md-8 view-content form-content">
            ...
            <h4 class="header-form text-center" >
              ...
              <?php  echo ucwords($info->tbl_adminName);  ?>
            </h4>
              ...
              <form method="post" action="#">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input id="EditFname" value="<?php  echo ($info->tbl_adminName);  ?>" class="form-control input" >
                </div>

                <div class="form-group col-md-6">
                  <label >Phone Number</label>
                  <input class="form-control input" id="EditPhone" type="number" value="<?php  echo ($info->tbl_adminTel);  ?>">
                  </select>
                </div>

                <div class="form-group col-md-6">
                  <label >E-mail</label>
                  <input class="form-control input" id="EditEmail" type="email" value="<?php  echo ($info->tbl_adminEmail);  ?>">
                </div>


                <div class="form-group col-md-6">
                  <label >Address </label>
                  <input class="form-control input" id="EditLoc1" type="text" value="<?php  echo ($info->tbl_adminAddress);  ?>">
                </div>
